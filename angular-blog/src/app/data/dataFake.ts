export const dataFake = [
  ...
  {
    "id":"2",
    "title": "Surgem Rumores de Possível Série Solo do Shadow na Paramount+",
    "description": "Após a introdução de Shadow em 'Sonic 3', especulações sobre uma série solo do personagem na Paramount têm ganhado força. Alguns fãs acreditam que, devido à popularidade de Shadow, a Paramount possa estar considerando um spin-off centrado nele. Entretanto, até o momento, não há confirmações oficiais sobre o desenvolvimento de uma série dedicada ao personagem.",
    "photoCover":"https://brasil.perfil.com/wp-content/uploads/2024/11/Sonic-3-trailer-destaque-em-Shadow.jpg"
  },
  {
    "id":"3",
  ...
  {
    "id":"4",
    "title": "Cena Pós-créditos de Sonic 3 Revela Novo Vilão e Primeira Aparição de Amy Rose",
    "description": "Na cena pós-créditos de 'Sonic 3', somos apresentados a Amy Rose e Metal Sonic, ampliando o universo cinematográfico do ouriço azul. Amy Rose, conhecida por sua personalidade forte e martelo característico, surge misteriosamente, sugerindo um papel significativo nas próximas aventuras. Em seguida, Metal Sonic, a contraparte robótica de Sonic criada pelo Dr. Robotnik, é revelado, insinuando desafios futuros para o herói. Essa introdução de personagens icônicos dos jogos eletrônicos promete novas emoções e confrontos nos próximos filmes da franquia.",
    "photoCover":"https://preview.redd.it/my-sonic-4-theory-on-amy-and-metal-sonic-v0-b4x1ddkhprge1.jpg?width=640&crop=smart&auto=webp&s=7868cfce261bd8109942a23f16d538d4c3df7a22"
  }
]
